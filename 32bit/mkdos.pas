...
// deprecated -- Function GetResultCode: Integer;
// deprecated -- Function TimeOut(Time:LongInt):Boolean; {If time is later than current time
  //in timerticks}
...
// returns DOS ERRORLEVEL  (deprecated here?)
Var
  Result: Byte;
  {$IFNDEF BASMINT}
    {$IFDEF WINDOWS}
