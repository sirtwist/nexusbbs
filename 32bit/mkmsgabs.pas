...
Procedure AbsMsgObj.SetHold(HS: Boolean);
  Begin
  End;
...
Procedure AbsMsgObj.YoursFirst(MsgNum:Longint; Name: String; Handle: String);
  Begin
  End;
...
Procedure AbsMsgObj.YoursPrior;
  Begin
  End;
...
Function AbsMsgObj.GETMSGID:STRING;
begin
GetMsgid:='';
end;

Function AbsMsgOBJ.GetReplyADDR:STRING;
begin
GetReplyADDR:='';
end;

Function AbsMsgOBJ.GetReplyTo:STRING;
begin
GetReplyTo:='';
end;

Function AbsMsgOBJ.GetReplyName:STRING;
begin
GetReplyName:='';
end;
...
Procedure AbsMsgObj.AddSubField(id: Word; Data: String);
begin
end;
