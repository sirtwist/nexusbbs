        ...
        #13:begin
                case x of
                        1:begin
                                ...
                                {tempbyte:=getcolor(3,8,text_color,'Hello 
there!');}
                        ...
                        2:begin 
                                setwindow4(w,2,9,77,18,8,0,8,'Message Colors','',TRUE);
                                {tempbyte:=getcolor(3,8,quote_color,'YN>  
How are you?');}
                                setwindow5(w,2,9,77,18,3,0,8,'Message Colors','',TRUE);
                                window(3,10,76,17);
                        ...
                        3:begin
                                setwindow4(w,2,9,77,18,8,0,8,'Message Colors','',TRUE);
                                {tempbyte:=getcolor(3,8,tag_color,'... 
Strike any user when ready.');}
                        ...
                        4:begin 
                                setwindow4(w,2,9,77,18,8,0,8,'Message Colors','',TRUE);
                                {tempbyte:=getcolor(3,8,oldtear_color,'___ 
Offline Mail Reader');}
                                setwindow5(w,2,9,77,18,3,0,8,'Message Colors','',TRUE);
                                window(3,10,76,17);
                        ...
                        5:begin
                                setwindow4(w,2,9,77,18,8,0,8,'Message Colors','',TRUE);
                                {tempbyte:=getcolor(3,8,tear_color,'--- 
Nexus v'+ver);}
                                setwindow5(w,2,9,77,18,3,0,8,'Message Colors','',TRUE);
                                window(3,10,76,17);
                        ...
                        6:begin
                                setwindow4(w,2,9,77,18,8,0,8,'Message Colors','',TRUE);
                                {tempbyte:=getcolor(3,8,origin_color,' * 
Origin: Here!');}
                                setwindow5(w,2,9,77,18,3,0,8,'Message Colors','',TRUE);
                                window(3,10,76,17);
