...
{}
begin
   // AsmWrite(ActiveScreenPtr^,80,Col,Row,Attr,St);
end; {FastWrite}

procedure PlainWrite(Col,Row:byte; St:StrScreen);
{}
begin
   // AsmPWrite(ActiveScreenPtr^,80,Col,Row,St);
end; {PlainWrite}
  ...
  {}
    begin
       // AsmAttr(ActiveScreenPtr^,80,Col,Row,Attr,Number);
    end; {Attribute}
...
{$IFDEF DPMI}
      ...
      begin
         BaseOfScreen := ptr(segB800,$0000); {Color}
